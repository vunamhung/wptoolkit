...
abstract class Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$id_base = isset($config['id_base']) ? $config['id_base'] : null;
		...
		$this->fields = !empty($config['fields']) ? apply_filters("vnh/widget/$id_base/fields", $config['fields']) : null;

		if (!empty($config['display'])) {
			$this->display = apply_filters("vnh/widget/$id_base/display", $config['display']);
		} else {
			$this->display = null;
		}
