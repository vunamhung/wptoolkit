...
function request($endpoint_url, $args = [], $raw_data = false) {
	...
	$remote = wp_safe_remote_get($endpoint_url, $args);
	...
	if (wp_remote_retrieve_response_code($remote) === 429) {
		return new WP_Error('too_many_requests', __('Too Many Requests', 'vnh_textdomain'), true);
	}

	if (wp_remote_retrieve_response_code($remote) !== 200) {
		return new WP_Error('invalid_status', __('Invalid Status code.', 'vnh_textdomain'), true);
	}
